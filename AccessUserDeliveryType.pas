...
type
  Tfrm_AccessUserDeliveryType = class(TForm)
    ToolBar1: TToolBar;
...
var
  frm_AccessUserDeliveryType: Tfrm_AccessUserDeliveryType;
...
procedure Tfrm_AccessUserDeliveryType.btn_SelectClick(Sender: TObject);
var
  i : Integer;
begin
...
procedure Tfrm_AccessUserDeliveryType.DeSelectAll1Click(Sender: TObject);
Var
   J      :Integer;
begin
...
procedure Tfrm_AccessUserDeliveryType.DisplayAccess;
Var
  R  :Integer;
...
//-------------------Build DeliveryTypes----------------------------------------
  ...
  qry_Access.SQL.Add('		WHEN EXISTS(SELECT * FROM DTAuthRts x WHERE x.UserId = :UserId AND x.DeliveryType = a.Description) THEN 1');
...
function Tfrm_AccessUserDeliveryType.Execute(UserId :String):Integer;
Var
  TempStr   :String;
begin
  mUserId := Userid;
...
procedure Tfrm_AccessUserDeliveryType.FormCreate(Sender: TObject);
var 
  bmp: TBitmap; 
begin 
...
procedure Tfrm_AccessUserDeliveryType.FormDestroy(Sender: TObject);
begin
  AccessChk.free;
end;

procedure Tfrm_AccessUserDeliveryType.SelectAll1Click(Sender: TObject);
Var
   J      :Integer;
begin
  For J := 0 to AccessChk.Count-1 do
...
procedure Tfrm_AccessUserDeliveryType.sgrd_AccessClick(Sender: TObject);
var
  pt: TPoint;
  grid: TStringgrid;
  aCol, aRow: Integer;
...
procedure Tfrm_AccessUserDeliveryType.sgrd_AccessDrawCell(Sender: TObject; ACol,
...
procedure Tfrm_AccessUserDeliveryType.ToggleCheckbox( acol, arow: Integer );
begin
