object frm_RelRecordTypeRecordCat: Tfrm_RelRecordTypeRecordCat
  Left = 0
  Top = 0
  Caption = 'Record Category Relationships'
  ClientHeight = 562
  ClientWidth = 474
  Color = clBtnFace
  ...
  object sgrd_RecordCat: TStringGrid
    Left = 8
    Top = 81
    Width = 457
    Height = 473
    ...
    TabOrder = 1
    OnClick = sgrd_RecordCatClick
    OnDrawCell = sgrd_RecordCatDrawCell
    ColWidths = (
      230
      46)
  end
