...
type
  Tfrm_AccessRoleReports = class(TForm)
    ToolBar1: TToolBar;
...
var
  frm_AccessRoleReports: Tfrm_AccessRoleReports;
...
procedure Tfrm_AccessRoleReports.btn_SelectClick(Sender: TObject);
var
  i : Integer;
begin
        ...
        begin
          If AccessChk.Strings[I-1] = '1' Then
            begin
              qry_Access.Close;
              qry_Access.SQL.Clear;
              qry_Access.SQL.Add('INSERT INTO ReportsRts (ReportId, RoleId) VALUES(:ReportId, :RoleId)');
...
procedure Tfrm_AccessRoleReports.DeSelectAll1Click(Sender: TObject);
Var
   J      :Integer;
begin
...
procedure Tfrm_AccessRoleReports.DisplayAccess;
Var
  R  :Integer;
...
//-------------------Build DeliveryTypes----------------------------------------
  ...
  qry_Access.SQL.Add('		WHEN EXISTS(SELECT * FROM ReportsRts x WHERE x.RoleId = :RoleId AND x.ReportID = a.ID) THEN 1');
...
function Tfrm_AccessRoleReports.Execute(RoleId :Integer):Integer;
Var
  TempStr   :String;
begin
  mRoleId := RoleId;
...
procedure Tfrm_AccessRoleReports.FormCreate(Sender: TObject);
var 
  bmp: TBitmap; 
begin 
...
procedure Tfrm_AccessRoleReports.FormDestroy(Sender: TObject);
begin
  AccessChk.free;
end;

procedure Tfrm_AccessRoleReports.SelectAll1Click(Sender: TObject);
Var
   J      :Integer;
begin
  For J := 0 to AccessChk.Count-1 do
...
procedure Tfrm_AccessRoleReports.sgrd_AccessClick(Sender: TObject);
var
  pt: TPoint;
  grid: TStringgrid;
  aCol, aRow: Integer;
...
procedure Tfrm_AccessRoleReports.sgrd_AccessDrawCell(Sender: TObject; ACol,
...
procedure Tfrm_AccessRoleReports.ToggleCheckbox( acol, arow: Integer );
begin
