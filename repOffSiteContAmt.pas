...
type
  Trep_OffSiteContAmt = class(TForm)
    report: TQuickRep;
    QRBand5: TQRBand;
    QRLabel26: TQRLabel;
...
var
  rep_OffSiteContAmt: Trep_OffSiteContAmt;
...
procedure Trep_OffSiteContAmt.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ...
  qry_Containers.SQL.Add('AND (b.Transaction_Type = ''COS'')');
...
procedure Trep_OffSiteContAmt.reportBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  Tot := 0;
end;

procedure Trep_OffSiteContAmt.lbl_CTotalPrint(sender: TObject;
  var Value: String);
begin
  Value := InttoStr(Tot);
end;

procedure Trep_OffSiteContAmt.lbl_RangePrint(sender: TObject;
  var Value: String);
begin
