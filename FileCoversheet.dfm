object frm_FileCoversheet: Tfrm_FileCoversheet
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'File Coversheet'
  ClientHeight = 104
  ClientWidth = 406
  Color = clBtnFace
  ...
  object qry_repRecordHead: TADOQuery
    ...
    SQL.Strings = (
      'SELECT '
        ...
        #9'f.Filenumber, f.Code, f.Branch, f.Department , f.FileType, f.Fi' +
        'lingMethod,'
      #9'f.EntryDate, f.Destruct,'
      #9'"RetentionPeriod" = CASE '
      #9#9'WHEN ISNULL(f.NoDest, 0) = 1 THEN '#39'No Not Destroy'#39
      
        #9#9'WHEN ISNULL(f.NoDest, 0) = 0 AND f.RetentionPeriod IS NOT NULL' +
        ' THEN CONVERT(varchar, f.RetentionPeriod)'
      
        #9#9'WHEN ISNULL(f.NoDest, 0) = 0 AND f.RetentionPeriod IS NULL THE' +
        'N CONVERT(varchar, ft.fRetentionPeriod)'
      #9'END, '
      #9'c.Name AS "CompanyName",'
      #9'b.Name AS "BranchName",'
      #9'd.Name AS "DeptName",'
      '  dbo.ap_GetCoversheetBacode (f.Filenumber, 2) AS BarcodedInfo'
      'FROM '
      #9'files f'
      ...
      '  INNER JOIN IndexDefinitions ft ON f.FileType = ft.Description'
      'WHERE'
      '  f.Filenumber = :mFile')
    Left = 304
    Top = 48
