...
var
  rep_DesContList: Trep_DesContList;
...
procedure Trep_DesContList.lbl_RangePrint(sender: TObject;
  var Value: String);
begin
  Value := 'From: '+DatetoStr(FromD)+' to '+DatetoStr(ToD);
end;

procedure Trep_DesContList.qry_Get_Br_Dpt_FTAfterScroll(
  DataSet: TDataSet);
begin
//============Total Containers Captured=========================================
  ...
  qry_GetTot.SQL.Add('AND (b.Transaction_Type = ''CDS'')');
...
procedure Trep_DesContList.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
