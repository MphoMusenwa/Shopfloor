...
var
  rep_RetContAmt: Trep_RetContAmt;
...
procedure Trep_RetContAmt.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Trep_RetContAmt.reportBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  Tot := 0;
end;

procedure Trep_RetContAmt.lbl_CTotalPrint(sender: TObject;
  var Value: String);
begin
  Value := InttoStr(Tot);
end;

procedure Trep_RetContAmt.lbl_RangePrint(sender: TObject;
  var Value: String);
begin
