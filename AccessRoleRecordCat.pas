...
type
  Tfrm_AccessRoleRecordCat = class(TForm)
    ToolBar1: TToolBar;
...
var
  frm_AccessRoleRecordCat: Tfrm_AccessRoleRecordCat;
...
procedure Tfrm_AccessRoleRecordCat.btn_SelectClick(Sender: TObject);
var
  i : Integer;
begin
...
procedure Tfrm_AccessRoleRecordCat.DeSelectAll1Click(Sender: TObject);
Var
   J      :Integer;
begin
...
procedure Tfrm_AccessRoleRecordCat.DisplayAccess;
Var
  R  :Integer;
...
//-------------------Build DeliveryTypes----------------------------------------
  ...
  qry_Access.SQL.Add('		WHEN EXISTS(SELECT * FROM RCAuthRts x WHERE x.RoleId = :RoleId AND x.RecordCat = a.RecCatType) THEN 1');
...
function Tfrm_AccessRoleRecordCat.Execute(RoleId :Integer):Integer;
Var
  TempStr   :String;
begin
  mRoleId := RoleId;
...
procedure Tfrm_AccessRoleRecordCat.FormCreate(Sender: TObject);
var 
  bmp: TBitmap; 
begin 
...
procedure Tfrm_AccessRoleRecordCat.FormDestroy(Sender: TObject);
begin
  AccessChk.free;
end;

procedure Tfrm_AccessRoleRecordCat.SelectAll1Click(Sender: TObject);
Var
   J      :Integer;
begin
  For J := 0 to AccessChk.Count-1 do
...
procedure Tfrm_AccessRoleRecordCat.sgrd_AccessClick(Sender: TObject);
var
  pt: TPoint;
  grid: TStringgrid;
  aCol, aRow: Integer;
...
procedure Tfrm_AccessRoleRecordCat.sgrd_AccessDrawCell(Sender: TObject; ACol,
...
procedure Tfrm_AccessRoleRecordCat.ToggleCheckbox( acol, arow: Integer );
begin
