...
var
  rep_DesRecList: Trep_DesRecList;
...
procedure Trep_DesRecList.lbl_RangePrint(sender: TObject;
  var Value: String);
begin
  Value := 'From: '+DatetoStr(FromD)+' to '+DatetoStr(ToD);
end;

procedure Trep_DesRecList.qry_Get_Br_Dpt_FTAfterScroll(
  DataSet: TDataSet);
begin
//============Total Containers Captured=========================================
  ...
  qry_GetTot.SQL.Add('AND (b.Transaction_Type = ''FDS'')');
...
procedure Trep_DesRecList.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
