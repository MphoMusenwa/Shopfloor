...
type
  Tfrm_AccessUserFilingArea = class(TForm)
    ToolBar1: TToolBar;
...
var
  frm_AccessUserFilingArea: Tfrm_AccessUserFilingArea;
...
procedure Tfrm_AccessUserFilingArea.btn_SelectClick(Sender: TObject);
var
  i : Integer;
begin
...
procedure Tfrm_AccessUserFilingArea.DeSelectAll1Click(Sender: TObject);
Var
   J      :Integer;
begin
...
procedure Tfrm_AccessUserFilingArea.DisplayAccess;
Var
  R  :Integer;
...
//-------------------Build DeliveryTypes----------------------------------------
  ...
  qry_Access.SQL.Add('		WHEN EXISTS(SELECT * FROM LAuthRts x WHERE x.UserId = :UserId AND x.Code = a.Warehouse) THEN 1');
...
function Tfrm_AccessUserFilingArea.Execute(UserId :String):Integer;
Var
  TempStr   :String;
begin
  mUserId := Userid;
...
procedure Tfrm_AccessUserFilingArea.FormCreate(Sender: TObject);
var 
  bmp: TBitmap; 
begin 
...
procedure Tfrm_AccessUserFilingArea.FormDestroy(Sender: TObject);
begin
  AccessChk.free;
end;

procedure Tfrm_AccessUserFilingArea.SelectAll1Click(Sender: TObject);
Var
   J      :Integer;
begin
  For J := 0 to AccessChk.Count-1 do
...
procedure Tfrm_AccessUserFilingArea.sgrd_AccessClick(Sender: TObject);
var
  pt: TPoint;
  grid: TStringgrid;
  aCol, aRow: Integer;
...
procedure Tfrm_AccessUserFilingArea.sgrd_AccessDrawCell(Sender: TObject; ACol,
...
procedure Tfrm_AccessUserFilingArea.ToggleCheckbox( acol, arow: Integer );
begin
